...
export interface ApiResponseChainProductOrder { 
    data?: ChainProductOrder;
    /**
     ...
     */
    status: ApiResponseChainProductOrder.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainProductOrder.
 */
export namespace ApiResponseChainProductOrder {
    /**
     * All properties of ApiResponseChainProductOrder.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainProductOrder',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainProductOrder.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainProductOrder',
                    dataType: 'string',
  ...
  // export const ApiResponseChainProductOrderValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainProductOrder>;
