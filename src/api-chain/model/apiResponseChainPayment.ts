...
export interface ApiResponseChainPayment { 
    data?: ChainPayment;
    /**
     ...
     */
    status: ApiResponseChainPayment.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainPayment.
 */
export namespace ApiResponseChainPayment {
    /**
     * All properties of ApiResponseChainPayment.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainPayment',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainPayment.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainPayment',
                    dataType: 'string',
  ...
  // export const ApiResponseChainPaymentValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainPayment>;
