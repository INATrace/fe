...
export interface ApiResponseChainDocumentRequirement { 
    data?: ChainDocumentRequirement;
    /**
     ...
     */
    status: ApiResponseChainDocumentRequirement.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainDocumentRequirement.
 */
export namespace ApiResponseChainDocumentRequirement {
    /**
     * All properties of ApiResponseChainDocumentRequirement.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainDocumentRequirement',
            vars: [
                {
                    ...
                    name: 'data',
                    classname: 'ApiResponseChainDocumentRequirement',
                    dataType: 'ChainDocumentRequirement',
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainDocumentRequirement.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainDocumentRequirement',
                    dataType: 'string',
  ...
  // export const ApiResponseChainDocumentRequirementValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainDocumentRequirement>;
