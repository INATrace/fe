...
export interface ApiResponseChainProduct { 
    data?: ChainProduct;
    /**
     ...
     */
    status: ApiResponseChainProduct.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainProduct.
 */
export namespace ApiResponseChainProduct {
    /**
     * All properties of ApiResponseChainProduct.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainProduct',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainProduct.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainProduct',
                    dataType: 'string',
  ...
  // export const ApiResponseChainProductValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainProduct>;
