...
export interface ApiResponseChainMeasureUnitType { 
    data?: ChainMeasureUnitType;
    /**
     ...
     */
    status: ApiResponseChainMeasureUnitType.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainMeasureUnitType.
 */
export namespace ApiResponseChainMeasureUnitType {
    /**
     * All properties of ApiResponseChainMeasureUnitType.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainMeasureUnitType',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainMeasureUnitType.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainMeasureUnitType',
                    dataType: 'string',
  ...
  // export const ApiResponseChainMeasureUnitTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainMeasureUnitType>;
