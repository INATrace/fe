...
export interface ApiResponseChainProcessingAction { 
    data?: ChainProcessingAction;
    /**
     ...
     */
    status: ApiResponseChainProcessingAction.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainProcessingAction.
 */
export namespace ApiResponseChainProcessingAction {
    /**
     * All properties of ApiResponseChainProcessingAction.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainProcessingAction',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainProcessingAction.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainProcessingAction',
                    dataType: 'string',
  ...
  // export const ApiResponseChainProcessingActionValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainProcessingAction>;
