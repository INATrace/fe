...
export interface ApiResponseChainUserCustomer { 
    data?: ChainUserCustomer;
    /**
     ...
     */
    status: ApiResponseChainUserCustomer.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainUserCustomer.
 */
export namespace ApiResponseChainUserCustomer {
    /**
     * All properties of ApiResponseChainUserCustomer.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainUserCustomer',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainUserCustomer.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainUserCustomer',
                    dataType: 'string',
  ...
  // export const ApiResponseChainUserCustomerValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainUserCustomer>;
