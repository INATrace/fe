...
export interface ApiResponseChainCompanyCustomer { 
    data?: ChainCompanyCustomer;
    /**
     ...
     */
    status: ApiResponseChainCompanyCustomer.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainCompanyCustomer.
 */
export namespace ApiResponseChainCompanyCustomer {
    /**
     * All properties of ApiResponseChainCompanyCustomer.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainCompanyCustomer',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainCompanyCustomer.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainCompanyCustomer',
                    dataType: 'string',
  ...
  // export const ApiResponseChainCompanyCustomerValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainCompanyCustomer>;
