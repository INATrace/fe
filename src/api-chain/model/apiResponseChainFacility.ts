...
export interface ApiResponseChainFacility { 
    data?: ChainFacility;
    /**
     ...
     */
    status: ApiResponseChainFacility.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainFacility.
 */
export namespace ApiResponseChainFacility {
    /**
     * All properties of ApiResponseChainFacility.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainFacility',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainFacility.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainFacility',
                    dataType: 'string',
  ...
  // export const ApiResponseChainFacilityValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainFacility>;
