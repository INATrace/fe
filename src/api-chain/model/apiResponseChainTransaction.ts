...
export interface ApiResponseChainTransaction { 
     ...
     */
    status: ApiResponseChainTransaction.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainTransaction.
 */
export namespace ApiResponseChainTransaction {
    /**
     * All properties of ApiResponseChainTransaction.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainTransaction',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainTransaction.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainTransaction',
                    dataType: 'string',
  ...
  // export const ApiResponseChainTransactionValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainTransaction>;
