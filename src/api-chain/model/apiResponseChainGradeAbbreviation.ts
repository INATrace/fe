...
export interface ApiResponseChainGradeAbbreviation { 
    data?: ChainGradeAbbreviation;
    /**
     ...
     */
    status: ApiResponseChainGradeAbbreviation.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainGradeAbbreviation.
 */
export namespace ApiResponseChainGradeAbbreviation {
    /**
     * All properties of ApiResponseChainGradeAbbreviation.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainGradeAbbreviation',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainGradeAbbreviation.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainGradeAbbreviation',
                    dataType: 'string',
  ...
  // export const ApiResponseChainGradeAbbreviationValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainGradeAbbreviation>;
