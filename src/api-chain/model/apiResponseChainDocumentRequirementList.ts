...
export interface ApiResponseChainDocumentRequirementList { 
    data?: ChainDocumentRequirementList;
    /**
     ...
     */
    status: ApiResponseChainDocumentRequirementList.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainDocumentRequirementList.
 */
export namespace ApiResponseChainDocumentRequirementList {
    /**
     * All properties of ApiResponseChainDocumentRequirementList.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainDocumentRequirementList',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainDocumentRequirementList.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainDocumentRequirementList',
                    dataType: 'string',
  ...
  // export const ApiResponseChainDocumentRequirementListValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainDocumentRequirementList>;
