...
export interface ApiResponseChainStockOrder { 
    data?: ChainStockOrder;
    /**
     ...
     */
    status: ApiResponseChainStockOrder.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainStockOrder.
 */
export namespace ApiResponseChainStockOrder {
    /**
     * All properties of ApiResponseChainStockOrder.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainStockOrder',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainStockOrder.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainStockOrder',
                    dataType: 'string',
  ...
  // export const ApiResponseChainStockOrderValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainStockOrder>;
