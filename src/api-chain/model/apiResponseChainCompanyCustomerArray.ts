...
export interface ApiResponseChainCompanyCustomerArray { 
    data?: Array<ChainCompanyCustomer>;
    /**
     ...
     */
    status: ApiResponseChainCompanyCustomerArray.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainCompanyCustomerArray.
 */
export namespace ApiResponseChainCompanyCustomerArray {
    /**
     * All properties of ApiResponseChainCompanyCustomerArray.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainCompanyCustomerArray',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainCompanyCustomerArray.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainCompanyCustomerArray',
                    dataType: 'string',
  ...
  // export const ApiResponseChainCompanyCustomerArrayValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainCompanyCustomerArray>;
