...
export interface ApiResponseProcessingOrderHistoryArray { 
    data?: Array<ProcessingOrderHistory>;
    /**
...
/**
 * Namespace for property- and property-value-enumerations of ApiResponseProcessingOrderHistoryArray.
 */
export namespace ApiResponseProcessingOrderHistoryArray {
    /**
     * All properties of ApiResponseProcessingOrderHistoryArray.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            vars: [
                {
                    metadata: ProcessingOrderHistory.formMetadata,
                    isReadOnly: false,
                    isEnum: false,
                    required: false,
                    name: 'data',
                    classname: 'ApiResponseProcessingOrderHistoryArray',
                    dataType: 'Array&lt;ProcessingOrderHistory&gt;',
                    isPrimitiveType: false,
                    isListContainer: true,
                    complexType: 'ProcessingOrderHistory'
                },
                {
                    isReadOnly: false,
                    isEnum: false,
  ...
  // export const ApiResponseProcessingOrderHistoryArrayValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseProcessingOrderHistoryArray>;
