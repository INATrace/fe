...
export interface ApiResponseChainProcessingEvidenceType { 
    data?: ChainProcessingEvidenceType;
    /**
     ...
     */
    status: ApiResponseChainProcessingEvidenceType.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainProcessingEvidenceType.
 */
export namespace ApiResponseChainProcessingEvidenceType {
    /**
     * All properties of ApiResponseChainProcessingEvidenceType.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainProcessingEvidenceType',
            vars: [
                {
                    ...
                    name: 'data',
                    classname: 'ApiResponseChainProcessingEvidenceType',
                    dataType: 'ChainProcessingEvidenceType',
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainProcessingEvidenceType.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainProcessingEvidenceType',
                    dataType: 'string',
  ...
  // export const ApiResponseChainProcessingEvidenceTypeValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainProcessingEvidenceType>;
