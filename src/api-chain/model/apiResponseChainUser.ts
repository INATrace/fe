...
export interface ApiResponseChainUser { 
    data?: ChainUser;
    /**
     ...
     */
    status: ApiResponseChainUser.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainUser.
 */
export namespace ApiResponseChainUser {
    /**
     * All properties of ApiResponseChainUser.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainUser',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainUser.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainUser',
                    dataType: 'string',
  ...
  // export const ApiResponseChainUserValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainUser>;
