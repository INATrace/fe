...
export interface ApiResponseChainBulkPayment { 
    data?: ChainBulkPayment;
    /**
     ...
     */
    status: ApiResponseChainBulkPayment.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseChainBulkPayment.
 */
export namespace ApiResponseChainBulkPayment {
    /**
     * All properties of ApiResponseChainBulkPayment.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseChainBulkPayment',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseChainBulkPayment.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseChainBulkPayment',
                    dataType: 'string',
  ...
  // export const ApiResponseChainBulkPaymentValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseChainBulkPayment>;
