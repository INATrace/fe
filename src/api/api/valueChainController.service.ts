...
/**
 * Namespace for listSelectedValueChainsForFacilityUsingGET.
 */
export namespace ListSelectedValueChainsForFacilityUsingGET {
    /**
     * Parameter map for listSelectedValueChainsForFacilityUsingGET.
     */
    export interface PartialParamMap {
      /**
       * Facility ID
    ...
    /**
     * Enumeration of all parameters for listSelectedValueChainsForFacilityUsingGET.
     */
    export enum Parameters {
      /**
       * Facility ID
    ...
    /**
     * A map of tuples with error name and `ValidatorFn` for each parameter of listSelectedValueChainsForFacilityUsingGET
     * that does not have an own model.
     */
    export const ParamValidators: {[K in keyof ListSelectedValueChainsForFacilityUsingGET.PartialParamMap]?: [string, ValidatorFn][]} = {
      id: [
              ['required', Validators.required],
      ],
      requestType: [
...
/**
 * Namespace for listSelectedValueChainsForProcessingActionUsingGET.
 */
export namespace ListSelectedValueChainsForProcessingActionUsingGET {
    /**
     * Parameter map for listSelectedValueChainsForProcessingActionUsingGET.
     */
    export interface PartialParamMap {
      /**
    ...
    /**
     * Enumeration of all parameters for listSelectedValueChainsForProcessingActionUsingGET.
     */
    export enum Parameters {
      /**
       * Processing action ID
    ...
    /**
     * A map of tuples with error name and `ValidatorFn` for each parameter of listSelectedValueChainsForProcessingActionUsingGET
     * that does not have an own model.
     */
    export const ParamValidators: {[K in keyof ListSelectedValueChainsForProcessingActionUsingGET.PartialParamMap]?: [string, ValidatorFn][]} = {
      id: [
              ['required', Validators.required],
      ],
      requestType: [
...
export class ValueChainControllerService {
  ...
  /**
   * Get a list of value chains that are selected for a facility by map.
   * 
   * @param map parameters map to set partial amount of parameters easily
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public listSelectedValueChainsForFacilityUsingGETByMap(
    map: ListSelectedValueChainsForFacilityUsingGET.PartialParamMap,
    observe?: 'body',
    reportProgress?: boolean): Observable<ApiPaginatedResponseApiValueChain>;
  public listSelectedValueChainsForFacilityUsingGETByMap(
    map: ListSelectedValueChainsForFacilityUsingGET.PartialParamMap,
  ...
  public listSelectedValueChainsForFacilityUsingGETByMap(
    ...
    observe: any = 'body',
    reportProgress: boolean = false): Observable<any> {
    return this.listSelectedValueChainsForFacilityUsingGET(
      map.id,
      map.requestType,
      map.limit,
      map.offset,
    ...
    /**
     * Get a list of value chains that are selected for a facility
     * 
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listSelectedValueChainsForFacilityUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'body', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<ApiPaginatedResponseApiValueChain>;
    public listSelectedValueChainsForFacilityUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'response', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<HttpResponse<ApiPaginatedResponseApiValueChain>>;
    public listSelectedValueChainsForFacilityUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'events', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<HttpEvent<ApiPaginatedResponseApiValueChain>>;
    public listSelectedValueChainsForFacilityUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe: any = 'body', reportProgress: boolean = false, additionalHeaders?: Array<Array<string>>): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling listSelectedValueChainsForFacilityUsingGET.');
        }
        ...
        const handle = this.httpClient.get<ApiPaginatedResponseApiValueChain>(`${this.configuration.basePath}/api/chain/value-chain/list/facility/${encodeURIComponent(String(id))}/selected`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
        ...
        if(typeof this.configuration.errorHandler === 'function') {
          return handle.pipe(catchError(err => this.configuration.errorHandler(err, 'listSelectedValueChainsForFacilityUsingGET')));
        }
        return handle;
    }
  ...
  /**
   * Get a list of value chains that are selected for a processing action by map.
   * 
   * @param map parameters map to set partial amount of parameters easily
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public listSelectedValueChainsForProcessingActionUsingGETByMap(
    map: ListSelectedValueChainsForProcessingActionUsingGET.PartialParamMap,
    observe?: 'body',
    reportProgress?: boolean): Observable<ApiPaginatedResponseApiValueChain>;
  public listSelectedValueChainsForProcessingActionUsingGETByMap(
    map: ListSelectedValueChainsForProcessingActionUsingGET.PartialParamMap,
  ...
  public listSelectedValueChainsForProcessingActionUsingGETByMap(
    ...
    observe: any = 'body',
    reportProgress: boolean = false): Observable<any> {
    return this.listSelectedValueChainsForProcessingActionUsingGET(
      map.id,
      map.requestType,
      map.limit,
      map.offset,
    ...
    /**
     * Get a list of value chains that are selected for a processing action
     * 
     * @param id Processing action ID
     * @param requestType Only count, only fetch, or return both values (if null)
     * @param limit Number of records to return. Min: 1, default: 100
     * @param offset Number of records to skip before returning. Default: 0, min: 0
     * @param sortBy Column name to be sorted by, varies for each endpoint, default is id
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listSelectedValueChainsForProcessingActionUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'body', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<ApiPaginatedResponseApiValueChain>;
    public listSelectedValueChainsForProcessingActionUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'response', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<HttpResponse<ApiPaginatedResponseApiValueChain>>;
    public listSelectedValueChainsForProcessingActionUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe?: 'events', reportProgress?: boolean, additionalHeaders?: Array<Array<string>>): Observable<HttpEvent<ApiPaginatedResponseApiValueChain>>;
    public listSelectedValueChainsForProcessingActionUsingGET(id: number, requestType?: 'COUNT' | 'FETCH', limit?: number, offset?: number, sortBy?: string, sort?: 'ASC' | 'DESC', observe: any = 'body', reportProgress: boolean = false, additionalHeaders?: Array<Array<string>>): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling listSelectedValueChainsForProcessingActionUsingGET.');
        }
        ...
        const handle = this.httpClient.get<ApiPaginatedResponseApiValueChain>(`${this.configuration.basePath}/api/chain/value-chain/list/processingAction/${encodeURIComponent(String(id))}/selected`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
        ...
        if(typeof this.configuration.errorHandler === 'function') {
          return handle.pipe(catchError(err => this.configuration.errorHandler(err, 'listSelectedValueChainsForProcessingActionUsingGET')));
        }
        return handle;
    }
