...
export namespace ListProcessingActionsByCompanyUsingGET {
    ...
    export interface PartialParamMap {
       ...
       */
      actionType?: 'PROCESSING' | 'FINAL_PROCESSING' | 'SHIPMENT' | 'TRANSFER';
      /**
