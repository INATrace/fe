...
export interface ApiResponseApiGradeAbbreviation { 
    data?: ApiGradeAbbreviation;
    /**
     ...
     */
    status: ApiResponseApiGradeAbbreviation.StatusEnum;
    validationErrorDetails?: ApiValidationErrorDetails;
}

/**
 * Namespace for property- and property-value-enumerations of ApiResponseApiGradeAbbreviation.
 */
export namespace ApiResponseApiGradeAbbreviation {
    /**
     * All properties of ApiResponseApiGradeAbbreviation.
     */
    ...
    export function formMetadata() {
        return  {
            ...
            classname: 'ApiResponseApiGradeAbbreviation',
            vars: [
                {
                ...
                },
                {
                    isReadOnly: false,
                    isEnum: true,
                    datatypeWithEnum: 'ApiResponseApiGradeAbbreviation.StatusEnum',
                    required: true,
                    name: 'status',
                    classname: 'ApiResponseApiGradeAbbreviation',
                    dataType: 'string',
  ...
  // export const ApiResponseApiGradeAbbreviationValidationScheme = {
  //     validators: [],
  //     fields: {
  //               data: {
  //                   validators: []
  ...
  //               },
  //     }
  // } as SimpleValidationScheme<ApiResponseApiGradeAbbreviation>;
