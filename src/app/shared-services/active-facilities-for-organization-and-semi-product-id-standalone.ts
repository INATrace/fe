...
export class ActiveFacilitiesForOrganizationAndSemiProductIdStandaloneService extends GeneralSifrantService<ChainFacility> {
  ...
  public initializeCodebook() {
    this.sifrant$ = this.sifrant$ || this.chainFacilityService.listFacilitiesForOrganizationAndSemiProductByMap({ ...this.requestParams }).pipe(
