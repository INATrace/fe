...
export class ActiveUserCustomersByOrganizationService extends GeneralSifrantService<ChainUserCustomer> {
  ...
  public makeQuery(key: string, params?: any): Observable<PagedSearchResults<ChainUserCustomer>> {
    ...
    let tmp = this.chainUserCustomerService.listUserCustomersForOrganizationByMap(reqPars).pipe(
  ...
  public placeholder(): string {
    let placeholder = $localize`:@@activeUserCustomersByOrganization.input.placehoder:Select ...`;
    return placeholder;
  }
