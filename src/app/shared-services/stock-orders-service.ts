...
export class StockOrdersService extends GeneralSifrantService<ChainStockOrder> {
  ...
  public placeholder(): string {
    let placeholder = $localize`:@@stockOrders.input.placehoder:Select purchase`;
    return placeholder;
  }
  ...
  public initializeCodebook() {
    this.sifrant$ = this.sifrant$ || this.chainStockOrderService.listStockOrdersByMap({ ...this.requestParams, purchaseOrderOnly: this.isPurchaseOrder, showPurchaseOrderOpenBalanceOnly: this.showPurchaseOrderOpenBalanceOnly }).pipe(
