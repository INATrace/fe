...
import { ClipInputTransactionModalResult } from '../stock-processing-order-details/clip-input-transaction-modal/model';
...
@Component({
  ...
  templateUrl: './stock-processing-order-details-old.component.html',
  styleUrls: ['./stock-processing-order-details-old.component.scss']
})
export class StockProcessingOrderDetailsOldComponent implements OnInit, OnDestroy {
  ...
  static ApiActivityProofEmptyObjectFormFactory(): () => FormControl {
    return () => {
      return new FormControl(StockProcessingOrderDetailsOldComponent.ApiActivityProofCreateEmptyObject(),
  ...
  private initializeListManager() {
    this.processingEvidenceListManager = new ListEditorManager<ApiActivityProof>(
      ...
      StockProcessingOrderDetailsOldComponent.ApiActivityProofEmptyObjectFormFactory(),
