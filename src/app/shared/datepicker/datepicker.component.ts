...
import { NgbDateParserFormatter, NgbDatepickerConfig, NgbDatepicker, NgbInputDatepicker } from '@ng-bootstrap/ng-bootstrap';
...
export class DatepickerComponent implements OnInit {
    ...
    onClick() {
        ...
        let start=this.datePickerInput.nativeElement.selectionStart;
        let end = this.datePickerInput.nativeElement.selectionEnd;
        ...
        if (value) {
            ...
            setTimeout(() => {
                if(document.activeElement == this.datePickerInput.nativeElement) {
                    this.datePickerInput.nativeElement.setSelectionRange(start,end); // pazi, to na safariju sproži change, zato je zgoraj guard proti ciklanju, hkrati pa naredi focus na elementu
                }
            })
