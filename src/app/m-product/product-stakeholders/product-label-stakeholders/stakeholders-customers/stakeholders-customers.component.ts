...
@Component({
  selector: 'app-stakeholders-customers',
  templateUrl: './stakeholders-customers.component.html',
  styleUrls: ['../product-label-stakeholders.component.scss']
})
export class StakeholdersCustomersComponent extends ProductLabelStakeholdersComponent {
