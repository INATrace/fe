...
@Component({
  selector: 'app-stakeholders-farmers',
  templateUrl: './stakeholders-farmers.component.html',
  styleUrls: ['../product-label-stakeholders.component.scss']
})
export class StakeholdersFarmersComponent extends ProductLabelStakeholdersComponent {
