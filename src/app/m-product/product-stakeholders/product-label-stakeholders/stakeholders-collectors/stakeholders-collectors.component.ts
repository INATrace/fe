...
@Component({
  selector: 'app-stakeholders-collectors',
  templateUrl: './stakeholders-collectors.component.html',
  styleUrls: ['../product-label-stakeholders.component.scss']
})
export class StakeholdersCollectorsComponent extends ProductLabelStakeholdersComponent {
